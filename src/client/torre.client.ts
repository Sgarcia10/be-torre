...
import { TorreJobsRequest, TorreJobsRequestAnd } from './dto/request/jobs.request';
...
export class TorreClient {
  ...
  getJobs(
    body: TorreJobsRequest | TorreJobsRequestAnd,
    currencyCode: string
  ): Promise<AxiosResponse<TorreJobsResponse>> {
